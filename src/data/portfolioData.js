...
export const nodes = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        name: "API Practice App",
        description: "Upcoming API-focused build with external data consumption and clean async state handling.",
        meta: ["Fetch", "REST", "State", "Coming Soon"],
        detail: "Upcoming project focused on async requests, loading states, error handling, and clean data presentation.",
        status: "Coming Soon",
        isPlaceholder: true,
